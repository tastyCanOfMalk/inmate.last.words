...
And we can remove stop words to get a better representation of important topics.  
...
Rather than browse lists of popular bigrams we can represent our most popular bigrams in a wordcloud, and also segregate by race to determine if any racial differences exist.  
...
NLP
  Monograms
    ...
    Common words - wordcloud, sentiment (remove?)
    Term frequency - bar
