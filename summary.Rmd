...
## Common words
Perhaps the easiest analysis is to simply list the most popular words used. We start with cleaning and then present the data.  
...
A prettier method of presentation might be to use a wordcloud instead.  
...
We can also sort by positive and negative sentinment words.  
