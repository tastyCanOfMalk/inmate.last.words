...
Education level is also relatively constant throughout the range of inmates. In the standard histogram we see a huge dropoff after education level 12 (assumedly High School, grade 12). In fact, our largest peaks occur between grades 9-12, indicating that not completing high school has a potentially huge impact in whether a crime is committed. 
...
We might conclude that those with a grade 9-11 education level could be considered high school dropouts, while those with an education level of 12 had a terminal education level of high school. We see that high school dropouts tend to have a slightly younger distribution
