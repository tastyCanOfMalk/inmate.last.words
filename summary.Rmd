...
We see clearly, based on the density plot, that time served between the different races represented are very much similar. When we look at the histogram we do notice there are far fewer hispanics and appear to be slightly more whites in the population.
